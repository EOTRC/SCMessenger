...
1. Reproduce and isolate the CoreBluetooth/btleplug panic with sanitized logs
   and a bounded probe lifecycle. A probe failure must be reported as
   unavailable, not take down the transport process or silently claim BLE
   readiness.
