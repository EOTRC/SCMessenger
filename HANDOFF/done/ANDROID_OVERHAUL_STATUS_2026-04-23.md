...
| Peer ID display |  (wrong label) |  (shows hash) |  | All need fix |
| QR format |  (exports hash) |  (exports hash) | N/A | All need fix |
| mDNS TXT records |  (unknown format) |  (unknown format) | N/A | Needs spec |
