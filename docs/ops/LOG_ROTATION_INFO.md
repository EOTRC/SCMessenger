...
Both `scripts/ios_extractor.py` and `scripts/adb_extractor.py` now implement automatic log rotation and retention management to prevent unbounded disk usage while maintaining recent debugging history.
...
- [scripts/ios_extractor.py](../../scripts/ios_extractor.py) - iOS implementation
- [scripts/adb_extractor.py](../../scripts/adb_extractor.py) - Android implementation
