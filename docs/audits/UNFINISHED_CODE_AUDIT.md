...
**Action Items:**
- [OK] **Fix immediately:** Unused imports in `core/src/transport/swarm.rs:5352-5353`
- [REVIEW] **Review & assess:** 39 dead_code suppressions — determine if genuinely future-facing or actually dead
- [NOTE] **Document:** Dead code inventory by module for visibility
...
**Severity:** [WARNING] **TRIVIAL** — These are never used in the test functions that follow.
...
1. **Immediate (this session):**
   - [OK] Remove unused imports from `core/src/transport/swarm.rs:5352-5353`
