...
The `scm-repo-agent` is now the default for all coding tasks in the SCMessenger repository. It is equipped to handle any task related to the development, maintenance, and improvement of the codebase, with strict adherence to AGENTS.md rules and docs/ops/LOG_EXTRACTION_STANDARD.md requirements.
