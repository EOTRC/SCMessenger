...
mimo
# Memory.md, docs/historical/session-reports/checkpoint.md, docs/historical/session-reports/notes.md loaded automatically
```
...
- `docs/historical/session-reports/checkpoint.md` — session state
- `docs/historical/session-reports/notes.md` — scratch notes
- `tasks/` — task progress
- `docs/historical/plans/fable5plan.md` — the spec
