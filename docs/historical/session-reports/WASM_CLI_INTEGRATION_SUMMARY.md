...
- `docs/historical/plans/WASM_TRANSPORT_PARITY_PLAN.md` - Comprehensive implementation plan
- `docs/historical/WASM_INTEGRATION_ANALYSIS.md` - Architecture analysis
