...
**Deployment Status:** Ready for field deployment. See `docs/historical/iOS/iOS_BUILD_DEPLOY_GUIDE.md` for instructions.
...
2. Created comprehensive build/deployment guide at `docs/historical/iOS/iOS_BUILD_DEPLOY_GUIDE.md`
...
- `iOS/SCMessenger/SCMessenger/Data/MeshRepository.swift` (backoff + circuit breaker)
- `docs/historical/iOS/iOS_BUILD_DEPLOY_GUIDE.md` (deployment guide - new)
