...
- **DELETE: `docs/BOOTSTRAP.md`** — Legacy bootstrap node documentation (knowledge moved to `.clinerules` §8.4, §15)
- **DELETE: `docs/historical/SCMessengerSKILL.md`** — Legacy custom skill definition
- **DELETE: `docs/historical/scmessenger-agent.md`** — Legacy custom agent profile
- **DELETE: `docs/historical/leanstral-integration.md`** — Legacy LeansTral integration guide
- **DELETE: `docs/historical/leanstral-execution-workflow.md`** — Legacy LeansTral workflow
...
- **DELETE: `docs/historical/workflow-improvements.md`** — Legacy LeansTral workflow improvements
...
3. ✅ Read root-level legacy markdowns (AGENTS.md, CLAUDE.md, docs/BOOTSTRAP.md, docs/historical/SCMessengerSKILL.md, docs/historical/scmessenger-agent.md, docs/historical/leanstral-integration.md, docs/historical/leanstral-execution-workflow.md)
