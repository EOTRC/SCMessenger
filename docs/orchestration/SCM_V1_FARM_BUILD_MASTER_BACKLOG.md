...
**Surviving authoritative sources** (verified readable): `REMAINING_WORK_TRACKING.md`, `tasks/*/progress.md` (31 tracks), `README.md`, `CHANGELOG.md`, `docs/historical/MASTER_BUG_TRACKER.md`, `API_EFFICIENCY_LEDGER.md`, `.claude/commands/scmqwen.md`, `HANDOFF/MORPH_LITE_HANDOFF.md`, `ORCHESTRATOR_DIRECTIVE.md`, `scripts/delegate_task.py`, all code.
