...
committed. Must be reconstructed from `docs/historical/audits/HERMES_FARM_AUDIT.MD` and applied here.
...
- `docs/historical/audits/HERMES_FARM_AUDIT.MD` lines 136-147 (exact diff from farm session)
