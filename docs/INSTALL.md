...
Initializing SCMessenger...
  ...
  [OK] Configuration
  [OK] Data directory: /Users/you/.local/share/scmessenger
  [OK] Identity created
...
- See [docs/platform/DOCKER_QUICKSTART.md](platform/DOCKER_QUICKSTART.md) for Docker deployment
