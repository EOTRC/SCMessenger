...
each verified task; as the active orchestrator you hold AGENTS.md rule 5(b)
commit + push authority -- push when the push carries verified work or
triggers a needed CI run (workers you delegate to hold no such authority
unless you explicitly grant it). Before declaring done, run the
